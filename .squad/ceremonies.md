...
| **Trigger** | auto |
| **When** | before |
| **Condition** | user-facing feature, AI-generated content, resume or job-posting data flow, or external factual claim |
| **Facilitator** | Lead |
| **Participants** | Lead, Rai, Fact Checker, Tester, all-relevant implementers |
| **Time budget** | focused |
| **Enabled** | ✅ yes |

**Agenda:**
1. Confirm the requested workflow and acceptance criteria
2. Review privacy, safety, and data-handling implications
3. Verify external claims and integration assumptions
4. Confirm test coverage and release readiness
