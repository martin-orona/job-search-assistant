...
- **Casting:** Uses the descriptive persistent name Fact Checker.
...
job-search-assistant captures job postings, compares them with resumes, and supports AI-assisted resume tailoring, application tracking, and search-effort reporting.
